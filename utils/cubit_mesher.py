...
sys.path.append('/opt/Coreform-Cubit-2024.8/bin')

# Uncomment for DRAC clusters
# sys.path.append('/home/akhanmo/Coreform-Cubit-2024.3/bin')
...
def mesh_and_PML(x_center, z_center, major_axis, minor_axis, alpha, proposed_P):
    ...
    change_params.modify_par_file(
        os.path.join(SPECFEM2D_DATA, "Par_file"), 294, new_content
    )
