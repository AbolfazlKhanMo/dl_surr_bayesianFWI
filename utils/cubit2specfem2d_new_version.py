...
# sys.stdout = open(os.path.join(BASE_DIR,'temp_output.log'), 'w')
...
#        return txt
    ...
    def pmls_write(self,pml_name):
        ...
        pml_file.close()
        print('Ok')
        cubit.cmd('set info off') # Turn on return messages from Cubit commands
        cubit.cmd('set echo off') # Turn on echo of Cubit commands
