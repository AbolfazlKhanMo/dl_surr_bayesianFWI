...
! 2D shape function derivatives, to check for negative Jacobians
  ...
  NUMBER_OF_TRANSITION_LAYERS_TO_ADD = 2
  ...
  SIZE_OF_XMIN_ELEMENT_TO_ADD = 75
  ...
  SIZE_OF_XMAX_ELEMENT_TO_ADD = 75
  ...
  SIZE_OF_ZMIN_ELEMENT_TO_ADD = 75
  ...
  if (ADD_ON_THE_ZMAX_SURFACE) then
    ...
    SIZE_OF_ZMAX_ELEMENT_TO_ADD = 75
