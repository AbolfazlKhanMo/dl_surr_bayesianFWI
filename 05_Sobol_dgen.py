...
from config import SPECFEM2D_WORKDIR
from config import iterations, initial_model
...
target_data = load_data(os.path.join(TARGET_DATA, "noiseless_data.bin"), n_values)  # We pass noiseless target data here

sobol_gen(baseline_data, target_data, iterations)
