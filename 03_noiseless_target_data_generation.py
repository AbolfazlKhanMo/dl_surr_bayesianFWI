...
from config import BASE_DATA, MONITOR_DATA, TARGET_DATA
...
def generate_target_from_baseline_and_monitor(
    ...
    """
    Computes (monitor - baseline) + 0% additive Gaussian noise and saves as noiseless_data.bin.
    ...
    target_path = target_dir / "noiseless_data.bin"
...
if __name__ == "__main__":
    generate_target_from_baseline_and_monitor(
        ...
        sigma_percent=.0,   # HERE WE SET THE NOISE TO ZERO BECAUSE THIS IS THE TRAINING DATASET
        seed=123,
    )
